...
#ifndef INTRINSIC_ICON_INTERPROCESS_REMOTE_TRIGGER_BINARY_FUTEX_H_
#define INTRINSIC_ICON_INTERPROCESS_REMOTE_TRIGGER_BINARY_FUTEX_H_
...
#endif  // INTRINSIC_ICON_INTERPROCESS_REMOTE_TRIGGER_BINARY_FUTEX_H_
